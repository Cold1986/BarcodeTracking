...
{
    /// <summary>
    /// Summary description for stockUpload
    /// </summary>
    public class stockUpload : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string uploadPath = context.Server.MapPath("\\files\\stock\\");
                ...
                if (file != null)
                {
                    ...
                    excelBiz.Excel2MySql(uploadPath, filename, userName, 1);
                    //异步执行excel 存mysql
                    new Thread(o =>
                    {

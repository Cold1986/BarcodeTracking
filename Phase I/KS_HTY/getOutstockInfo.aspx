<%@ Page Title="查看生产入库记录" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="getOutstockInfo.aspx.cs" Inherits="KS_HTY.getOutstockInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnSearch").click(function () {
                var params = {
                    ...
                    strUser: $('#ContentPlaceHolder1_txtUser').val().trim(),//操作人员
        ...
        function createTable(currPage, limit, total) {
            ...
            html.push(' <thead><tr><th>销售订单号</th><th>成品编码</th><th>生产序列号</th><th>装箱数量</th><th>上传人员</th><th>上传日期</th></tr></thead><tbody>');

            for (var i = (currPage - 1) * limit; i < (currPage - 1) * limit + showNum; i++) {
                //$.each(data.mes, function (i, list) {
                html.push('<tr><td>' + data.mes[i].SONo || '' + '</td>');
    ...
    <div class="container">
        <form role="form" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" id="txtUser" placeholder="上传人员" class="form-control" runat="server" />
                </div>

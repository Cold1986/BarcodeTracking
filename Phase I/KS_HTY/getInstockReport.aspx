<%@ Page Title="查看生产入库统计" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="getInstockReport.aspx.cs" Inherits="KS_HTY.getInstockReport" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnSearch").click(function () {
                bchkJobNo = $('#chkJobNo').get(0).checked;
                ...
                if (!bchkJobNo && !bchkJDE && !bchkProNo && !bchkDate) {
                    alert('请至少显示一个字段');
                    return;
                }
        ...
        function createTable(currPage, limit, total) {
            ...
            for (var i = (currPage - 1) * limit; i < (currPage - 1) * limit + showNum; i++) {
                html.push('<tr>');
                if (bchkJobNo) {
                    html.push('<td>' + data.mes[i].JobNo || '' + '</td>');
                }
                if (bchkJDE) {
    ...
    <div class="container">
        <form role="form" class="form-horizontal">
            <div class="form-group">
                <label for="txtSONo" class="col-sm-2 control-label">工单号</label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <label for="chkJobNo" class="checkbox-inline col-sm-2">
                    <input type="checkbox" id="chkJobNo" value="A" />工单号
                </label>

<%@ Page Title="上传销售出库清单" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="OutstockFiles.aspx.cs" Inherits="KS_HTY.OutstockFiles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('.navbar-nav').children('li').removeClass('active').eq(0).addClass('active');
        ...
        function createTable(currPage, limit, total) {
            ...
            html.push(' <thead><tr><th>销售订单号</th><th>成品编码</th><th>生产序列号</th><th>装箱数量</th></tr></thead><tbody>');

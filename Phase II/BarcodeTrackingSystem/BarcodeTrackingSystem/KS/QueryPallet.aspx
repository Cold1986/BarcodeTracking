<%@ Page Title="" Language="C#" MasterPageFile="~/KS/KSMasterPage.Master" AutoEventWireup="true" CodeBehind="QueryPallet.aspx.cs" Inherits="BarcodeTracking.KS.QueryPallet" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="../js/KS/QueryPallet.js"></script>
    ...
    <div class="content">
        ...
        <div id="myTabContent" class="tab-content">
            <div class="results tab-pane fade in active" id="tab1">
                总完工数量：<span id="totalNumbers"></span>
